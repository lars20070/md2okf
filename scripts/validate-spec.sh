...
# Validate the Pi Docker Sandbox Kit spec (kits/md2okf/spec.yaml) against the
...
echo "Validating ${repo_root}/kits/md2okf against the current Sandbox Kit schema..."
exec sbx kit validate "${repo_root}/kits/md2okf/"
